...
!function (e) {
    ...
    var f = [], i = Object.keys, _ = {}, c = {}, C = !0, n = /^(no-?highlight|plain|text)$/i,
    ...
    function E(e) {
        ...
        return function e(n, t) {
            for (var r = n.firstChild; r; r = r.nextSibling) 3 === r.nodeType ? t += r.nodeValue.length : 1 === r.nodeType && (a.push({
                ...
                offset: t,
                node: r
            }), t = e(r, t), g(r).match(/br|hr|img|input/) || a.push({event: "stop", offset: t, node: r}));
            return t
        }(e, 0), a
    }
    ...
    function R(n) {
        ...
        }(n) ? [s(n, {starts: n.starts ? s(n.starts) : null})] : Object.isFrozen(n) ? [s(n)] : [n]
    }
...
hljs.registerLanguage("cpp", function (e) {
    ...
    var r = "decltype\\(auto\\)", a = "[a-zA-Z_]\\w*::", i = "(" + r + "|" + t(a) + "[a-zA-Z_]\\w*" + t("<.*?>") + ")",
        c = {cN: "keyword", b: "\\b[a-z\\d_]*_t\\b"}, s = {
            cN: "string",
            v: [{
                b: '(u8?|U|L)?"',
                e: '"',
            ...
            c: [{b: /\\\n/, relevance: 0}, e.inherit(s, {cN: "meta-string"}), {
                cN: "meta-string",
                b: /<.*?>/,
                e: /$/,
                i: "\\n"
            }, e.CLCM, e.CBCM]
        }, l = {cN: "title", b: t(a) + e.IR, relevance: 0}, u = t(a) + e.IR + "\\s*\\(", p = {
        ...
        }, m = [c, e.CLCM, e.CBCM, n, s], d = {
            v: [{b: /=/, e: /;/}, {b: /\(/, e: /\)/}, {bK: "new throw return else", e: /;/}],
            k: p,
            c: m.concat([{b: /\(/, e: /\)/, k: p, c: m.concat(["self"]), relevance: 0}]),
            relevance: 0
        }, b = {
            cN: "function",
            b: "(" + i + "[\\*&\\s]+)+" + u,
            ...
            k: p,
            i: /[^\w\s\*&:<>]/,
            c: [{b: r, k: p, relevance: 0}, {b: u, rB: !0, c: [l], relevance: 0}, {
                cN: "params",
                b: /\(/,
                e: /\)/,
                k: p,
                relevance: 0,
                c: [e.CLCM, e.CBCM, s, n, c, {b: /\(/, e: /\)/, k: p, relevance: 0, c: ["self", e.CLCM, e.CBCM, s, n, c]}]
            }, c, e.CLCM, e.CBCM, o]
        };
    return {
